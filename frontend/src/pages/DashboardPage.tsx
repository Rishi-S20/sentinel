    ...
    <div className="min-h-screen bg-surface-950 text-white">
      ...
      <div className="p-8">
        ...
        <div className="flex gap-3 mb-8">
          ...
          />
          <input
            className="bg-surface-800 border border-surface-700 rounded px-3 py-2 text-sm w-36"
            ...
            {agents.map((agent) => (
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  <span className={`text-xs px-2 py-1 rounded-full ${agent.status === "active" ? "bg-bullish/20 text-bullish" : "bg-surface-700 text-surface-400"}`}>
                    {agent.status}
                  </span>
                </div>
